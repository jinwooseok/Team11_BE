...
class GetParticipatedVotesServiceTest {

	@InjectMocks GetParticipatedVotesService getParticipatedVotesService;
	...
	public void myPageParticipateTest() {
		...
		GetVotesResponse.MyPage result = getParticipatedVotesService.execute(userId);
		// then
